...
export default function Dashboard() {
  ...
  const [sortBy, setSortBy] = useState<
    "price-desc" | "price-asc" | "name" | "next-payment"
  >("price-desc");
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <h1 className="text-lg sm:text-2xl font-semibold tracking-tight truncate">
              <span className="hidden sm:inline">Subscription </span>Tracker
            </h1>
          </div>
              ...
              <div className="flex items-center gap-1">
                {lastSyncedAt && (
                  <span className="text-xs text-muted-foreground hidden sm:inline">
                    Saved {formatRelativeTime(lastSyncedAt)}
                  </span>
                )}
                <Button
                  variant="ghost"
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {CATEGORIES.filter((cat) =>
                  subscriptions.some((s) => s.category === cat)
                ).map((cat) => (
                  <Button
                    key={cat}
            ...
            {paymentMethods.length > 1 && (
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  <Button
                    variant={
                      filterPaymentMethod === "All" ? "default" : "outline"
                    }
                    size="sm"
                    className="h-7 text-xs"
                  ...
                  {paymentMethods.map((pm) => (
                    <Button
                      key={pm}
                      variant={
                        filterPaymentMethod === pm ? "default" : "outline"
                      }
                      size="sm"
                      className="h-7 text-xs"
      ...
      <footer className="mt-auto max-w-3xl mx-auto w-full px-4 py-6 flex items-center justify-between text-xs text-muted-foreground border-t">
        <a
          href="https://github.com/janat-t/subscription-tracker-qwen"
          target="_blank"
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/janat-t/subscription-tracker-qwen/issues/new"
            target="_blank"
            rel="noopener noreferrer"
