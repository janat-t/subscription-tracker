...
const AuthContext = createContext<{ showAuth: () => void }>({
  showAuth: () => {},
});
...
export default function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const {
      ...
      if (event === "SIGNED_IN" && localStorage.getItem("subscriptions"))
        migrateLocalStorage();
    });
  ...
  if (recovering)
    return <RecoverPasswordScreen onDone={() => setRecovering(false)} />;
